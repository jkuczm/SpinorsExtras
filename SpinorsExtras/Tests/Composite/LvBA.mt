...
(*Test[
	LvBA[2 b - z SpM[P, 1], y],
	2 LvBA[b, y] - z LvBA[SpM[P, 1], y],
	TestID -> "2 args: linear combination of spinors, arbitrary"
];
Test[
	LvBA[2 b - z SpM[P, 1], Q],
	2 LvBA[b, Q] - z LvBA[SpM[P, 1], Q],
	TestID -> "2 args: linear combination of spinors, LVector"
];
Test[
	LvBA[2 b - z SpM[P, 1], a],
	2 LvBA[b, a] - z LvBA[SpM[P, 1], a],
	TestID -> "2 args: linear combination of spinors, massless Spinor"
];
Test[
	LvBA[2 b - z SpM[P, 1], SpM[Q, 1]],
	2 LvBA[b, SpM[Q, 1]] - z LvBA[SpM[P, 1], SpM[Q, 1]],
	TestID -> "2 args: linear combination of spinors, massive Spinor"
];
TestUnchanged[
	LvBA[b + x, a],
	TestID -> "2 args: linear combination with non-spinor, massless Spinor"
];

Test[
	LvBA[x, 3 w SpM[Q, -1, c] + z a],
	3 w LvBA[x, SpM[Q, -1, c]] + z LvBA[x, a],
	TestID -> "2 args: arbitrary, linear combination of spinors"
];
Test[
	LvBA[P, 3 w SpM[Q, -1, c] + z a],
	3 w LvBA[P, SpM[Q, -1, c]] + z LvBA[P, a],
	TestID -> "2 args: LVector, linear combination of spinors"
];
Test[
	LvBA[b, 3 w SpM[Q, -1, c] + z a],
	3 w LvBA[b, SpM[Q, -1, c]] + z LvBA[b, a],
	TestID -> "2 args: massless Spinor, linear combination of spinors"
];
Test[
	LvBA[SpM[P, -1], 3 w SpM[Q, -1, c] + z a],
	3 w LvBA[SpM[P, -1], SpM[Q, -1, c]] + z LvBA[SpM[P, -1], a],
	TestID -> "2 args: massive Spinor, linear combination of spinors"
];
TestUnchanged[
	LvBA[b, a + y],
	TestID -> "2 args: massless Spinor, linear combination with non-spinor, "
];

Test[
	LvBA[2 b - z SpM[P, 1], 3 w SpM[Q, -1, c] + z a]
	,
	6 w LvBA[b, SpM[Q, -1, c]] + 2 z LvBA[b, a]
		- 3 w z LvBA[SpM[P, 1], SpM[Q, -1, c]] - z^2 LvBA[SpM[P, 1], a]
	,
	TestID ->
		"2 args: linear combination of spinors, linear combination of spinors"
];*)
